...
app.get('/profile',(req, res) => { 
    console.log('asd');
    let sql = "select dno, concat (fname,' ',mname,' ',lname) as name, age, address, contact, bday, licence_no, balance,pass from drivertbl where dno = '"+eno+"'";
...
app.post('/load',(req, res) => { 
    var balance = req.param("para1");
    let sql = "update drivertbl set balance = "+balance+" where dno = "+eno;
    db.query(sql, function (err, result, fields) {
        if (err) throw err;
...
app.get('/home',(req, res) => { 
    ...
    console.log("qwe");
    let sql = "select dno from drivertbl where dno = "+eno+"";
...
app.get('/',(req, res) => { 
    let sql = "select dno,email,pass,licence_no from drivertbl";
...
app.get('/payment',(req, res) => { 
    ...
    let sql = "select dno,balance from drivertbl where dno = "+eno+"";
    console.log(eno+"payment");
    db.query(sql, function (err, driver, fields) {
        if (err) throw err;
...
app.get('/balance',(req, res) => { 
    let payment = req.param('para1');
    let sql = "update drivertbl set balance = "+payment+"  where dno = "+eno;
    console.log(eno+"payment");
    db.query(sql, function (err, driver, fields) {
        if (err) throw err;
...
app.get('/updatepass',(req, res) => {
    ...
    let sql = "update drivertbl set pass = '"+pass+"' where dno = "+eno;
